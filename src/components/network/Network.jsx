    ...
    <div className='container-fluid'>
        <header className='networkhead'>
          <div className='d-flex justify-content-between mx-2 '>
            <Link className='py-3' style={{textDecoration:"none",color:'black'}} to="#">{Authuser.username}</Link>
      ...
      <ul className='list'>
        ...
        <footer  style={{backgroundColor:'#ECF2FF'}}>
             <div className='text-center'><Link to="/commonlayout/password" style={{textDecoration:"none",color:"black"}}>Change Password</Link></div>
            <button className='btn btn-info w-100 ' style={{backgroundColor:'#ECF2FF',border:"none"}} onClick={()=>{handleLogout()}}>Logout</button>
        </footer>
    </div>
  )
}
