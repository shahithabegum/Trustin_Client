    ...
    <div className="formcontainer  my-3">
      <form className="form ml-5" onSubmit={formik.handleSubmit}>
        ...
        <Row className='my-1'>
          <Col  >
            <div class="form-group">
              <label for="password" className="label my-1 company-label">New Password</label>
              <input
        ...
        <Row className='my-1'>
          ...
          <Row className=" mx-2 my-1 justify-content-center" >
            ...
            <button className="btn btn-outline-info w-100  my-2" type="submit" disabled={!enable}>Change</button>
            </Col>
            <Col lg={4} md={6} sm={12} ml={0} >
